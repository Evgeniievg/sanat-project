  ...
  return (
    <div className='article'>
      ...
      <div className='image__container'>
        <img src='./ma-yuan.jpg' className='article__image'/>
      ...
      <div className='image__container'>
        <img src='./ma-yuan__scientist.png' className='article__image'/>
        <span className='image__subtext'>Scholar with His Servant on a Mountain Terrace (松溪观鹿图) (New York)</span>
      </div>
      <div className='image__container'>
        <img src='./ma-yuan__fisherman.png' className='article__image'/>
      ...
      <div className='image__container'>
        <img src='./ma-yuan__wildlife.png' className='article__image'/>
      ...
      <div className='image__container'>
        <img src='./ma-yuan__dances.png' className='article__image'/>
