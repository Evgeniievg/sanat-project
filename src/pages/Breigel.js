...
function Breigel() {
  return (
    <div className='article'>
      ...
      <p className='article__text'>Bruegel married the daughter of the prominent Flemish painter Pieter Coecke van Aelst, and had two sons, Pieter the Younger and Jan Brueghel the Elder, who were both successful artists in their own right.</p>
      <p className='article__text'>Bruegel is most famous for his landscape paintings, which feature scenes of the Flemish countryside and the lives of the people who lived there. He was one of the first artists to focus on landscapes as the subject of his paintings, and his works are known for their intricate details, vivid colors, and lifelike scenes.</p>
      <p className='article__text'>In addition to his landscapes, Bruegel is also known for his allegorical and genre paintings. These works often feature scenes from everyday life, such as weddings, harvest festivals, and peasant dances. He used these scenes to comment on contemporary issues, such as poverty, famine, and religious conflict.</p>
      <p className='article__text'>Throughout his career, Bruegel received numerous commissions for paintings from wealthy patrons, and his works were highly sought after for their realism, intricate details, and vivid colors. He was a prolific artist, and is estimated to have created over 40 paintings and over 60 drawings in his lifetime.</p>
      <p className='article__text'>One of Bruegel's most famous works is "The Tower of Babel," which was painted in 1563. It was created in 1563 and depicts the biblical story of the tower built by the people of Babel in an attempt to reach the heavens. The painting shows the massive tower surrounded by a bustling cityscape, with people of all walks of life going about their daily business.</p>
      <p className='article__text'>In the painting, the tower reaches towards the heavens and is depicted as an impressive structure, but it is also shown as being incomplete, with the workers struggling to finish it. This has been interpreted as a commentary on the futility of human ambition and the dangers of pride.</p>
      <p className='article__text'>The cityscape in the painting is full of life, with people of all ages and professions depicted in intricate detail. Bruegel's use of color, light, and perspective creates a lively, realistic scene, and his attention to detail is apparent in the depiction of the city's buildings, animals, and other elements.</p>
      ...
      <p className='article__text'>The painting depicts the biblical story of the crucifixion of Jesus Christ, showing a crowded and chaotic procession making its way through a mountainous landscape. The foreground of the painting is filled with a diverse cast of characters, including mourners, soldiers, and onlookers, all of whom seem deeply affected by the events unfolding before them.</p>
      <p className='article__text'>One of the key elements of the painting is the sense of movement and energy, with people and animals flowing in different directions throughout the composition. Bruegel's masterful use of light and color adds to the sense of depth and realism in the painting, creating a vivid and powerful image.</p>
      ...
      <p className='article__text'>The painting depicts a countryside scene, with workers in a wheat field harvesting the crops. In the foreground, several workers are depicted threshing the wheat and stacking it into sheaves. In the background, others are shown plowing the fields and caring for their livestock. Bruegel's use of vivid colors and intricate details bring the scene to life, and his attention to detail is evident in the depiction of the workers' clothing and tools, as well as the surrounding landscape.</p>
      <p className='article__text'>"The Harvesters" is often considered one of Bruegel's most important works, and is widely regarded as a masterpiece of Renaissance art. It is known for its lifelike representation of rural life, and its vivid depiction of the various tasks and activities involved in harvesting crops. The painting is also considered a prime example of Bruegel's mastery of landscape composition, and his ability to convey the relationships between man and nature in his works.</p>
      ...
      <p className='article__text'>"Massacre of the Innocents" is a large oil-on-panel painting, measuring approximately 110 x 164 cm. The painting shows the massacre taking place in the center, with soldiers wielding swords and mothers desperately trying to protect their children. To the left of the scene, villagers can be seen fleeing in panic, while to the right, others are shown going about their business indifferently. This contrast between the horror of the massacre and the indifference of the villagers serves to amplify the painting's social commentary.</p>
      ...
      <p className='article__text'>Bruegel died in 1569 at the age of 44. Despite his relatively short career, his influence on the world of art was significant, and he is considered one of the greatest Netherlandish painters of the sixteenth century. Today, his works can be found in many of the world's leading art museums, including the Metropolitan Museum of Art in New York and the Kunsthistorisches Museum in Vienna.</p>
    </div>
  )
}
