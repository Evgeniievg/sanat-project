...
import './article.css'
import assaFirst from '../assets/assa-1.png';
import assaSecond from '../assets/assa-2.png';
import assaThird from '../assets/assa-3.png';
  ...
  return (
    <div className='article'>
      ...
      <div className='image__container'>
        <img src={assaFirst} className='article__image'/>
      ...
      <div className='image__container'>
        <img src={assaSecond} className='article__image'/>
      ...
      <div className='image__container'>
        <img src={assaThird} className='article__image'/>
      ...
      <div className='image__container'>
        <img src={assaFour} className='article__image'/>
        <span className='image__subtext'>Sergey Bugaev on the set of "Assya"</span>
      </div>
      ...
      <div className='image__container'>
        <img src={assaFive} className='article__image'/>
        <span className='image__subtext'>Alexander Domogarov as Alexander I</span>
      </div>
      <div className='image__container'>
        <img src={assaSix} className='article__image'/>
